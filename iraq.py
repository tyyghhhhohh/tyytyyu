...
def send_welcome(message):
    if message.chat.type == 'supergroup':
        bot.reply_to(message, "✅ اهلا بك في بوت البحث عن سوال ضمن موقع جيك 👇🏻👇🏻\n"
                            ...
                            "2- سوف يتم الرد عليك بروابط 80% تحتوي على سوالك ، اذا كان سوالك من ضمن روابط قم بنسخ الرابط و إرساله إلى @Qissm22 \n"
        ...
        if message.chat.type == 'supergroup':
            ...
            for i in m['data']['search']['study']['responseContent']['docs']:
                ...
                bot.reply_to(message, "Links 📍🌐 :\n\n" + us + "\n\n ⏱ Time : " + str(
                    mma) + "\n\nBy Eng Mahmoud Fadhil 🛡 @Qissm22\n\nGo to bot to get solution @Qissm22 ✅✅\n\nBest Wishes")
    except:
